...
\author{
	...
	\and
	\\Curso 2019-2020\\
	\texttt{Estructura de Computadores I - Grupo (\textbf{numero de grupo})}
}
\date{\today}
...
\begin{document}
	...
	En la decodoficación de la instrucción se mira el valor de la instrucción bit a bit de izquierda a derecha y según esos valores va saltando  a la instrucción correspondiente. 
...
Para comprobar que nuestra emulación se ejecuta correctamente, hemos decidido probar  con  un  código  que  utilizase  el  resto  de  instrucciones  que  quedan  por  ejecutar  en las dos pruebas proporcionadas en la práctica.
\begin{center}
\begin{adjustbox}{center}
\begin{tabular}{cccc}
\ChangeRT{1.25pt}
...
\end{adjustbox}
\end{center}
Este programa no tiene 'sentido' ya que solo queremos probar que las instrucciones que no se habian tratado antes funcionen. Tras la ejecución de este programa, en la dirección @\$100C debería haber un 4
...
;Una subrutina para calcular los flags Z & N y otra Ãºnicamente para
...
GET_A: ;Pone en el registro A0 la direcciÃ³n del operando a
...
GET_B: ;Pone en el registro A1 la direcciÃ³n del operando b
...
GET_C: ;Pone en el registro A2 la direcciÃ³n del operando c
...
GET_K: ;Pone en el registro D2 el valor k con extensiÃ³n
...
GET_I: ;Pone en el registro A4 la direcciÃ³n de T1 o T0
...
GET_J: ;Pone en el registro A4 la direcciÃ³n de B6 o B7
