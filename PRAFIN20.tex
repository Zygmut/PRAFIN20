...
\end{adjustbox}
\end{center}\par
\noindent Este programa no tiene 'sentido' ya que solo queremos probar que las instrucciones que no se habian tratado antes funcionen. Tras su ejecución, en la dirección @\$100C debería haber un 4Hex
